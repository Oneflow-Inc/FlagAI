...
Adapted from https://github.com/microsoft/unilm/tree/master/beit. Originally MIT License, Copyright (c) 2021 Microsoft.
"""
import os
import math
...
class EVA_CLIP(BaseModel):
    def __init__(self, config, **kwargs):
        ...
        """
        super(EVA_CLIP,self).__init__(config, **kwargs)
